...
<head>
    ...
    <link rel="stylesheet" href="./src/css/manage_revenue.css">
                ...
                <div class="sidebar-wrapper">
                    <div class="sidebar-close">
                        ...
                        <a href="/shop" class="sidebar-img">
                            <img src="assest/images/logo-white-text.png" alt="logo">
            ...
            <div class="header-body">
                <div class="wrapper">
                    <a href="<?php
                                ...
                                ?>" class="header-logo">
                        <img src="assest/images/logo-white-text.png" alt="">
                        <div class="shop-header-name">Cửa hàng </div>
                    </a>
                    <!-- ?mod=<?= $mod ?>&act=<?= $act ?> -->
                    <!-- Form search header------------>
                    ...
                    <div class="header-search-right">
                        ...
                        <div class="header-search-right-item">
                            <div class="header-item-icon-right">
                                <i class="fa-solid fa-gift"></i>
                            </div>
                            <div class="header-search-item-text">Chương trình khuyến mãi</div>
                        </div>
                        <div class="header-search-right-item">
                            <div class="header-item-icon-right">
                                <i class="fa-solid fa-bell"></i>
                            </div>
                            <div class="header-search-item-text">Thông báo</div>
                        </div>
