    ...
    <div class="wrapper">
        ...
        <div class="detail-body">
            <div class="detail-tab">
                ...
                <a href="?mod=page&act=collection&category=<?= $san_pham['product']['slugCategory'] ?>"
                ...
                <div class="detail-right">
                    ...
                    <div class="detail-rate">
                        <div class="detail-rate-left">
                            <span>
                                <?= round($classProduct->get_star_product($san_pham['product']['id']), 2) ?? 0 ?>
                            </span>
                    ...
                    <div class="detail-group">
                        ...
                        <div class="detail-info-quantity">
                            <div class="detail-amount">
                                ...
                                <input id="input_quantity" class="detail-info-quantity-item detail-input-quantity"
                                    type="text" value="1" />
                    ...
                    <div class="detail-btn-body detail-btn-body-edit" style="margin-top:30px">
                        <button class="detail-btn detail-btn-cart detail_btn_add" data_type="add_cart"
                            product_id="<?= $san_pham['product']['id'] ?>">
                            <i class="fa-solid fa-cart-plus"></i>
                            Thêm vào giỏ hàng
                        </button>
                        <button class=" detail-btn  detail-btn-add detail-btn-buy detail_btn_add" data_type="buy_now"
                            product_id="<?= $san_pham['product']['id'] ?>">
                            <!-- <i class="fa-solid fa-cart-plus"></i> -->
                            <span>Mua ngay</span>
                        </button>
            ...
            <div class="shop-top">
                    ...
                    <div class="shop-info">
                        <div class="shop-body">
                            ...
                            <div class="shop-info-right">
                                <div class="shop-name">
                                    <?= $thong_tin_shop['shop_info']['name'] ?>
                                </div>
                                <div class="shop-online">Online 4 minutes</div>
                            </div>
                        </div>
                        <div class="shop-info-btn-wrapper">
                            <a href="?mod=page&act=shop&uuid=<?= $thong_tin_shop['shop_info']['uuid'] ?>"
                                class="shop-btn">
                ...
                <div class="shop-group">
                    ...
                    <div class="shop-item">
                        ...
                        <div class="shop-item-info">
                            <?= $classFormat->diffForHumans($thong_tin_shop['shop_info']['created_at']) ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="shop-item-slogan">
                <div class="shop-item-slogan-info">Cửa hàng chuyên cung cấp các mặt hàng quần áo thời trang, trang sức
                    dành cho các cô gái</div>
            </div>
                        ...
                        <div class="detail-review-user">
                            <div class="detail-review-user__inforeview">
                                ...
                                <div class="detail-review-user__info">
                                    <div class="detail-review-user__name">
                                        <?= $value['full_name'] ?>
                                    </div>
