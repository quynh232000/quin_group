...
// add to cart
function update_cart_user(type, product_id, quantity = "", render_cart = false) {
  $.ajax({
              ...
              item.product_info.quantity
                    ...
                    <div class="cart-info">
                        <div class="cart-checkbox">
                            <input class="item-cart-checkbox" ${
                              item.check ? "checked" : ""
                                ...
                                type="checkbox"
                                onchange="update_cart_user('${item.check ?'uncheck':'check'}','${item.product_info.id}',1,true)"
                                >
                        </div>
                        <div class="cart-item-pro">
                            ...
                            <div class="cart-info-right">
                                <a href="?mod=page&act=detail&product= ${item.product_info.slug}" class="cart-item-name">
                    ...
                    <div class="cart-quantity">
                        ...
                        <div class="cart-item-count">
                            <div class="cart-count-btn " onclick="update_cart_user('minus','${item.product_info.id}',1,true)" ><i
                                    class="fa-solid fa-minus"></i></div>
                            <input type="text" class="cart-count-input" readonly
                                value="${item.quantity}">
                            <div class="cart-count-btn " onclick="update_cart_user('plus','${item.product_info.id}',1,true)" ><i
                    ...
                    <div class="cart-action">
                        ...
                        <div class="cart-item-action-icon" onclick="update_cart_user('delete','${item.product_info.id}',1,true)">
...
function like_product(product_id, type) {
    $.ajax({
        ...
        data = JSON.parse(data);
        if(type =='like'){
            $(".detail_like_heart").html(`<i class="fa-solid fa-heart" onclick="like_product(${product_id},'unlike')"></i>`)
            $('.count_like_product').text(+$('.count_like_product').text()+1)
        }else{
            $(".detail_like_heart").html(`<i class="fa-regular fa-heart" onclick="like_product(${product_id},'like')"></i>`)
            $('.count_like_product').text(+$('.count_like_product').text()-1)
